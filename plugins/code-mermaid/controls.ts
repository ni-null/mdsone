...
export function buildMermaidControlsHtml(): string {
  return [
    ...
    '      <button type="button" class="mdsone-mermaid__btn mdsone-mermaid__pan-btn mdsone-mermaid__cell-up" data-pan="up" aria-label="Pan up" title="Pan up">↑</button>',
    ...
    '      <button type="button" class="mdsone-mermaid__btn mdsone-mermaid__pan-btn mdsone-mermaid__cell-left" data-pan="left" aria-label="Pan left" title="Pan left">←</button>',
    `      <button type="button" class="mdsone-mermaid__btn mdsone-mermaid__pan-btn mdsone-mermaid__pan-btn--home" data-pan="home" aria-label="Center view" title="Center view">${RESET_ICON}</button>`,
    '      <button type="button" class="mdsone-mermaid__btn mdsone-mermaid__pan-btn mdsone-mermaid__cell-right" data-pan="right" aria-label="Pan right" title="Pan right">→</button>',
    '      <span class="mdsone-mermaid__panel-gap" aria-hidden="true"></span>',
    '      <button type="button" class="mdsone-mermaid__btn mdsone-mermaid__pan-btn mdsone-mermaid__cell-down" data-pan="down" aria-label="Pan down" title="Pan down">↓</button>',
